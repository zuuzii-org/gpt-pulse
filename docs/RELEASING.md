...
本文档用于发布 LLM Pulse macOS 应用和配套的 Codex 插件。当前基准版本为 `1.4.0`，品牌署名统一使用 **Zuuzii**。Claude Code/Qwen3.7 功能版本继续规划为 `2.0.0`。
...
```text
dist/LLM-Pulse-1.4.0.dmg
dist/LLM-Pulse-1.4.0.dmg.sha256
dist/appcast.xml
```
