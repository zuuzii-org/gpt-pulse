...
> 决策日期：2026-07-12
>
> 当前发布基线：LLM Pulse v1.4.0（品牌迁移版本）
>
> 目标版本：LLM Pulse v2.0.0（尚未发布），计划 build `7` 或更高
...
- 从已安装 LLM Pulse v1.4.0 执行一次真实 Sparkle 更新到 v2.0 候选构建。
...
| App filename 改名破坏 Sparkle | v1.4.0 已承接品牌文件名迁移；v2.0 继续做原地升级回归 |
