...
[下载最新的已签名、已公证 DMG](https://github.com/zuuzii-org/llm-pulse/releases/latest)。**LLM Pulse v1.4.0** 要求 macOS 14 或更高版本，同时支持 Apple Silicon 和 Intel Mac。Claude Code 与 Qwen3.7 支持继续安排在 v2.0.0。
...
当前 v1.4.0 版本支持本机 Codex Desktop 创建的根任务。Claude Code 与 Qwen3.7 支持计划在 LLM Pulse v2.0.0 中加入，详见 [v2 实施计划](docs/LLM_PULSE_V2_PLAN.md)；v2.0.0 尚未发布。
